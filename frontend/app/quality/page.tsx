    ...
    <>
      <div className="page-h">
        <div>
          ...
          <p>The whole dataset&rsquo;s fitness across five quality dimensions, with every finding traced to its source table and classified as a data error, a verified clinical finding, or a documented caveat. To judge a specific cohort&rsquo;s fitness, build it on the Cohorts page and open its <b>Data fitness</b> lens.</p>
        </div>
      </div>
